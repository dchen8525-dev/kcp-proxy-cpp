...
```bash
# 下载deb包（以v0.0.7为例）
wget https://github.com/dchen8525-dev/kcp-proxy-cpp/releases/download/v0.0.7/kcp-proxy-server_0.0.7_amd64.deb

# 安装
sudo dpkg -i kcp-proxy-server_0.0.7_amd64.deb
...
```
KCP-Proxy-Client-0.0.7-Setup.exe     # NSIS 安装包（推荐）
KCP-Proxy-Client-0.0.7-Portable.exe  # 免安装单文件版
```
